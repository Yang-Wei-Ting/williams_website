# Generated by Django 3.1.6 on 2021-02-03 10:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prod_desc', models.TextField(blank=True, null=True, verbose_name='Description')),
                ...
                ('prodcat_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.productcategory', verbose_name="Product Category's ID")),
                ('vend_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.vendor', verbose_name="Vendor's ID")),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('cust_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name="Customer's ID")),
                ('prod_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.product', verbose_name="Product's ID")),
            ],
        ),
    ]

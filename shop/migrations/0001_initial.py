# Generated by Django 4.0.4 on 2022-05-21 14:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prodcat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.productcategory')),
                ('vend', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='shop.vendor')),
            ],
            options={
                'ordering': ('prod_name', ),
            },
